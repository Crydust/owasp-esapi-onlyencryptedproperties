 ...
 * it actually extends from {@code java.util.Properties} for applications that
 * need an instance of that class. In order to do so, the {@code getProperty}
 * and {@code setProperty} methods were modified to throw
 * {@code EncryptionRuntimeException} instead of {@code EncryptionException}.
 *
...
public class ReferenceEncryptedProperties extends java.util.Properties implements EncryptedProperties {
     ...
     * {@inheritDoc}
     *
     * @throws IOException Thrown if input stream invalid or does not correspond
     * to Java properties file format.
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * For JDK 1.5 compatibility, this method has been overridden convert the
     * Reader into an InputStream and call the superclass constructor.
     *
     * @throws IOException Thrown if {@code Reader} input stream invalid or does
     * not correspond to Java properties file format.
     */
